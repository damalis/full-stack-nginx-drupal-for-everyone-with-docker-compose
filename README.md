...
00 01 * * * tar -czvf /home/ubuntu/${DIRECTORY_PATH}/backups/'backup-example.com-'$(date +"\%Y-\%m-\%dT\%H-\%M-\%S")'.tar.gz' --exclude='drupal' --exclude='drupal' --exclude='backups' /home/ubuntu/${DIRECTORY_PATH}
